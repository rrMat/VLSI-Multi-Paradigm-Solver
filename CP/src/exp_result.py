...
STD_CHUFFED_NR = base_ref_CNR + "out_data_std.csv"
CML_CHUFFED_NR = base_ref_CNR + "out_data_cml.csv"
SYB_CHUFFED_NR = base_ref_CNR + "out_data_syb.csv"

STD_GECODE_NR = base_ref_GNR + "out_data_std.csv"
CML_GECODE_NR = base_ref_GNR + "out_data_cml.csv"
SYB_GECODE_NR = base_ref_GNR + "out_data_syb.csv"

STD_ORTOOLS_NR = base_ref_ORNR + "out_data_std.csv"
CML_ORTOOLS_NR = base_ref_ORNR + "out_data_cml.csv"
SYB_ORTOOLS_NR = base_ref_ORNR + "out_data_syb.csv"
...
#    ["STD or-tools no rotation", "CML or-tools no rotation", "SYB or-tools no rotation"])


write_experimental_result(
     "CP/stats/total_stats_no_rotation.csv",
     [
         STD_CHUFFED_NR,
         CML_CHUFFED_NR,
         SYB_CHUFFED_NR,
